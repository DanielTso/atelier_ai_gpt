...
_**SUPERSEDED by `docs/SESSION_HANDOFF_2026-09-01.md` — read that instead.** This file is a point-in-time record of the project at T1-T8 of the Dynamic Model Registry build; its open items and migration status were true on 2026-08-24 and are stale now (notably: it lists migration `0017` as pending — `0017` is applied). Kept for history. Supersedes `docs/SESSION_HANDOFF_2026-07-21.md`._
