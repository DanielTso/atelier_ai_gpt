...
_This is the bootstrap doc for a new session. The project CLAUDE.md is the source of truth for how the code works; this doc tracks **where we are in the multi-phase build**. **For current state (through v4.24.1) read `docs/SESSION_HANDOFF_2026-06-24.md` first** — it supersedes the dated status below._
